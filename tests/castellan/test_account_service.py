...
from castellan.core.services.account_service import Account, AccountService
...
class TestAccount:
    ...
    def test_account_exists_raises_runtime_error_on_exception(self, mock_objects):
        ...
        with pytest.raises(RuntimeError, match='An error occurred while querying account'):
    ...
    @patch('castellan.core.services.account_service.Account.objects')
    def test_get_account_by_username_raises_conflict_error_on_multiple_results(self, mock_objects):
    ...
    @patch('castellan.core.services.account_service.Account.objects')
    def test_get_account_by_username_raises_runtime_error_on_exception(self, mock_objects):
    ...
    @patch('castellan.core.services.account_service.Account.objects')
    def test_get_account_by_email_raises_conflict_error_on_multiple_results(self, mock_objects):
...
class TestAccountService:
    ...
    def test_create_account_success(self, mock_asdict, mock_datetime, mock_account_exists, mock_account_class):
        ...
        self.mock_parser.parse.assert_called_once_with(ims=bytearray(kel), kvy=self.mock_kvy, local=True)

    @patch('castellan.core.services.account_service.Account')
    @patch('castellan.core.services.account_service.AccountService.account_exists')
    def test_create_account_raises_conflict_error_when_account_exists(self, mock_account_exists, mock_account_class):
    ...
    @patch('castellan.core.services.account_service.Account')
    @patch('castellan.core.services.account_service.AccountService.account_exists')
    def test_create_account_raises_runtime_error_on_parse_failure(self, mock_account_exists, mock_account_class):
    ...
    @patch('castellan.core.services.account_service.Account')
    @patch('castellan.core.services.account_service.AccountService.account_exists')
    def test_create_account_raises_runtime_error_when_aid_not_in_kevers(self, mock_account_exists, mock_account_class):
        ...
        with pytest.raises(RuntimeError, match='parsing kel into Kevery for aid=test_aid'):
            self.service.create_account(doc, kel)
    ...
    @patch('castellan.core.services.account_service.datetime')
    @patch('castellan.core.services.account_service.asdict')
    def test_create_account_raises_runtime_error_on_save_failure(self, mock_asdict, mock_datetime, mock_account_exists, mock_account_class):
    ...
    def test_get_account_by_aid_returns_account(self, mock_get_account):
        """Test that get_account_by_aid returns account"""
        mock_account = Mock()
        mock_get_account.return_value = mock_account

        result = self.service.get_account_by_aid('test_aid')
    ...
    @patch.object(AccountService, 'get_account')
    def test_update_account_raises_not_found_error_when_account_not_found(self, mock_get_account):
    ...
    @patch.object(AccountService, 'get_account')
    @patch('castellan.core.services.account_service.datetime')
    def test_update_account_with_kel_raises_runtime_error_on_parse_failure(self, mock_datetime, mock_get_account):
    ...
    @patch.object(AccountService, 'get_account')
    @patch('castellan.core.services.account_service.datetime')
    def test_update_account_does_not_update_if_kel_sn_not_increased(self, mock_datetime, mock_get_account):
    ...
    @patch.object(AccountService, 'get_account')
    @patch('castellan.core.services.account_service.datetime')
    def test_update_account_returns_none_when_no_updates(self, mock_datetime, mock_get_account):
    ...
    @patch.object(AccountService, 'get_account')
    @patch('castellan.core.services.account_service.datetime')
    def test_update_account_ignores_nonexistent_fields(self, mock_datetime, mock_get_account):
    ...
    @patch.object(AccountService, 'get_account')
    @patch('castellan.core.services.account_service.datetime')
    def test_update_account_raises_runtime_error_on_save_failure(self, mock_datetime, mock_get_account):
...
class TestAccountServiceIntegration:
    ...
    @patch('castellan.core.services.account_service.datetime')
    @patch('castellan.core.services.account_service.asdict')
    def test_create_account_full_workflow(self, mock_asdict, mock_datetime, mock_account_exists, mock_account_class):
        ...
        assert result == mock_account
        assert mock_account.lastModified == 1234567890
        assert mock_account.kel == '-----BEGIN KERI KEY EVENT LOG-----\ntest_kel_data\n-----END KERI KEY EVENT LOG-----'
    ...
    @patch.object(AccountService, 'get_account')
    @patch('castellan.core.services.account_service.datetime')
    def test_update_account_full_workflow_with_kel_update(self, mock_datetime, mock_get_account):
